  ...
  return [
    {
      ...
      description:
        'Complete hardware specifications including CPU, memory, GPU, storage, and network',
    ...
    },
    {
      ...
      description:
        'Detailed system topology including NUMA nodes, PCIe topology, and interconnects',
      mimeType: 'application/json',
    },
    {
      ...
      description:
        'Detailed information about all GPUs including utilization, memory, and NVLink topology',
      mimeType: 'application/json',
    },
    {
    ...
    },
    {
      ...
      description:
        'Storage devices information including capacity, type, and performance characteristics',
      mimeType: 'application/json',
    },
    {
...
export function isHardwareResourceURI(uri: string): boolean {
  return Object.values(HardwareResourceURIs).includes(
    uri as (typeof HardwareResourceURIs)[keyof typeof HardwareResourceURIs]
  );
}
